...
\begin{figure}
	\includegraphics[]{map.png} % Figure image
...
\section{Results}
\begin{figure}
\includegraphics[]{posterior_distributions.png}
...
\begin{figure}
	...
	\caption{A majestic grizzly bear. This figure was in the stock latex template I used as an example of how to insert figures. It's not remotely relevant to the manuscript, but he brightens the place up, so I left him in for now. This also covers us in the event that a reviewer asks about bears as a pollination vector.}
