...
```{r caterpillar-plots, fig.cap="Change in log posterior density over four independent MCMC chains. The first 500 iterations of each chain have been removed as burn-in.", fig.width=22/2.54}
